...
This repository contains my final project for the Intro Data Mining / Machine Learning course. The project focuses on building and evaluating machine learning models to predict heart disease using a structured clinical dataset.
